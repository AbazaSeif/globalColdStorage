...
if ($_SESSION['searchtype'] == 1) {
    $storage_info = array();
    $pro_type = mysqli_real_escape_string($dbconnect, $_GET['name']);
    $sqlquery1 = "SELECT `storage_name`, `contact` FROM `storage_info` WHERE `product_type` = '$pro_type'";
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h3 class="text-center">
                        <?php 
                            if ($_SESSION['searchtype'] == 1) {
                                echo $arrstr_info . " cold storage found that store " . $pro_type;
                            } else {
                                echo $arrstr_info . " cold storage found in " . $location;
                            }
                        ?>
                    </h3>
